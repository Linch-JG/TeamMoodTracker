...
.PHONY: help install test api frontend run clean
...
frontend:
	TEAM_MOOD_API_URL="$(API_URL)" poetry run streamlit run src/team_mood_tracker/frontend/submission_form.py --server.address "$(API_HOST)" --server.port "$(STREAMLIT_PORT)"
